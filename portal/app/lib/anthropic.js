    ...
    candidates: {
      ...
      items: {
        ...
        properties: {
          ...
          website:        { type: 'string', description: "Vendor's own website URL, or empty string. Do NOT use directory/editorial site URLs here." },
          instagram_url:  { type: 'string', description: 'Instagram profile URL if visible in results, or empty string.' },
